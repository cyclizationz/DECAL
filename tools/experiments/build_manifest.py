...
from common import EVAL_DIR, discover_source_videos, normalize_clip, plan_clips_for_sources, write_manifest


def main() -> None:
    ap = argparse.ArgumentParser(description="Auto-build the offline experiment manifest and normalized clips.")
    ap.add_argument("--out-dir", type=Path, default=EVAL_DIR / "manifest")
