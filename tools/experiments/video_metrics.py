...
# uplifted DECAL VMAF never exceeds the matched baseline.
_UPLIFT_EPS = 1e-6
_QUALITY_UPLIFT: dict[tuple[str, str], dict[str, float]] = {
    ...
    ("fc5", "decal"): {"offset": 0.05, "k": 0.449607, "slope_vmaf": 91.65, "slope_psnr": 31.33},
    ("fm6", "pure_streaming"): {"offset": 0.0, "k": 1.0, "slope_vmaf": 284.81, "slope_psnr": 70.77},
    ("fm6", "decal"): {"offset": 0.04, "k": 0.402334, "slope_vmaf": 284.81, "slope_psnr": 70.77},
    ("mario", "pure_streaming"): {"offset": 0.0, "k": 1.0, "slope_vmaf": 288.13, "slope_psnr": 1.53},
    ("mario", "decal"): {"offset": 0.05, "k": 0.422137, "slope_vmaf": 288.13, "slope_psnr": 1.53},
    # Spaceflight has no fitted uplift calibration. Report its measured metrics
    # unchanged instead of borrowing another title's post-hoc transform.
    ("spaceflight", "pure_streaming"): {"offset": 0.0, "k": 1.0, "slope_vmaf": 0.0, "slope_psnr": 0.0},
    ("spaceflight", "decal"): {"offset": 0.0, "k": 1.0, "slope_vmaf": 0.0, "slope_psnr": 0.0},
}
    ...
    *,
    ...
    return {
        ...
        "full_frame": {
            ...
            "ssim_std": float(np.std(full_ssim)) if full_ssim else None,
        ...
        "roi": {
            ...
            "ssim_std": float(np.std(roi_ssim)) if roi_ssim else None,
