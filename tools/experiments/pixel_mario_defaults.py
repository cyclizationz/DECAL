...
from common import MARIO_TEMPLATES

PIXEL_TEMPLATES = MARIO_TEMPLATES

# Pixel sweep best-effort winner: p90_b15_f1_k0.80_og1 (eval/pixel_enc_sweep)
...
def mario_encoder_protocol_line() -> str:
    return (
        "- Exp1 encoder (matched pure + DECAL, all games): `libx264`, `medium`, `tune=none`, "
